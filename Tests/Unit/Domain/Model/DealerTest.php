...
/**
 * Test case for class \JS\Marketplace\Domain\Model\Dealer.
 *
 ...
 */
class DealerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \JS\Marketplace\Domain\Model\Dealer();
	}
	...
	{
		$countryFixture = new \JS\Marketplace\Domain\Model\Country();
