...
/**
 * Test case for class \JS\Marketplace\Domain\Model\Producer.
 *
 ...
 */
class ProducerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \JS\Marketplace\Domain\Model\Producer();
	}
